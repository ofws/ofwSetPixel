...
void ofApp::setup(){
    ...
    gui.setup();
    gui.add(bLearnBg.setup("learn background 'L'", true));
    ...
    ofSetWindowShape(width*4, height*4);
...
void ofApp::draw(){
    ...
    if (bDrawDebug) {
        ...
        ofDrawBitmapStringHighlight(s, 20, height*2-50);
        ...
        ofSetColor(255, alphaCount);
        ofDrawBitmapString("press ' ' (spacebar) to toggle debug mode", 20, 20);
    }
}
