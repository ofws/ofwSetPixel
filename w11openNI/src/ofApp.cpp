...
void ofApp::setupRecording(string _filename) {
...
void ofApp::setupPlayback(string _filename) {
...
void ofApp::drawPointCloud(ofxUserGenerator * user_generator, int userID) {
